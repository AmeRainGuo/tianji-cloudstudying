...
public interface PromotionClient {
    ...
    List<CouponDiscountDTO> findDiscountSolution(@RequestBody List<OrderCourseDTO> orderCourseDTOs);
    ...
    void writeOffCoupon(@ApiParam("用户优惠券id集合") @RequestParam List<Long> couponIds);
